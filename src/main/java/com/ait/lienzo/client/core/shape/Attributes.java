...
/**
 * Created by romartin on 3/16/16.
 */
public class Attributes {
    ...
    public final Point2D getScale()
    {
        ...
        if (null != scale)
        {
            final Point2D.Point2DJSO pjso = scale.cast();
    ...
    public final Point2D getShear()
    {
        ...
        if (null != shear)
        {
            final Point2D.Point2DJSO pjso = shear.cast();
    ...
    public final Point2D getOffset()
    {
        ...
        if (null != offset)
        {
            final Point2D.Point2DJSO pjso = offset.cast();
    ...
    public final Transform getTransform()
    {
        ...
        if (null != xrfm)
        {
            final Transform.TransformJSO pjso = xrfm.cast();
    ...
    public final Point2D getPoint2D(final String name)
    {
        ...
        if (null != point)
        {
            final Point2D.Point2DJSO pjso = point.cast();
